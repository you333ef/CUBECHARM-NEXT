        ...
        <div className="max-w-2xl mx-auto space-y-3 sm:space-y-4">
          ...
          >
            ...
            <div className="flex-1 text-right min-w-0">
              <h3 className="text-base sm:text-lg font-bold text-[#1a1a1a]">Upload Without Pro Mode</h3>
          ...
          <button
onClick={() =>
  handleOptionClick('ad', '/userportal/createdad', {
    search: 'source=new_upload_with_pro_mode',
  })
}
          ...
          >
            ...
            <div className="flex-1 text-right min-w-0">
              <h3 className="text-base sm:text-lg font-bold text-[#1a1a1a]">Upload With Pro Mode</h3>
